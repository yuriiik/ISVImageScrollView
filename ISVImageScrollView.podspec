...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ISVImageScrollView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kupratsevich@gmail.com/ISVImageScrollView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kupratsevich@gmail.com' => 'yurii.kupratsevych@elementum.com' }
  s.source           = { :git => 'https://github.com/kupratsevich@gmail.com/ISVImageScrollView.git', :tag => s.version.to_s }
